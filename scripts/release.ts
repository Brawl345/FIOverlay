...
const GECKO_ID = 'fioverlay@brawl345.github.com';
const CHROME_BIN =
...
function chromeExtensionId(pemPath: string): string {
...
<gupdate xmlns='http://www.google.com/update2/response' protocol='2.0'>
  <app appid='${chromeExtensionId(pemPath)}'>
...
function main() {
  ...
  const { crxOut, xpiOut, pemPath } = buildArtifacts(pkg, version);
  writeUpdateManifests(pkg, version, repo, pemPath);
